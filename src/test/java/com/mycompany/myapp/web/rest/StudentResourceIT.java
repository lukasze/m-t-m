...
class StudentResourceIT {
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION);
        return student;
    }
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
        return student;
    }
    ...
    void putNewStudent() throws Exception {
        ...
        updatedStudent.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
