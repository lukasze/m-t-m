...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lab.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LAB_LIST actions', async () => {
    ...
    it('dispatches FETCH_LAB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LAB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LAB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LAB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LAB actions', async () => {
      const expectedActions = [
        {
