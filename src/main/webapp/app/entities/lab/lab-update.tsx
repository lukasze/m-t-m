        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Title" id="lab-title" name="title" data-cy="title" type="text" />
              <ValidatedField label="Descritpion" id="lab-descritpion" name="descritpion" data-cy="descritpion" type="text" />
